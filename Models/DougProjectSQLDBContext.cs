...
{
    public partial class DougProjectSQLDBContext : DbContext
    {
        public DougProjectSQLDBContext()
        {
        }

        public DougProjectSQLDBContext(DbContextOptions<DougProjectSQLDBContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:dougsqlserverproject.database.windows.net,1433;Initial Catalog=DougProjectSQLDB;Persist Security Info=False;User ID=dougproject;Password=Sqlserver1404!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECAF6F66913");
